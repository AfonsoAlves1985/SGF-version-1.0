...
export interface SupplierSpace {
  id: number;
  name: string;
  description?: string;
  location?: string;
...
export interface SupplierSpaceManagerProps {
  spaces: SupplierSpace[];
...
export function SupplierSpaceManager({
  spaces,
  selectedSpace,
  onSelectSpace,
  onCreateSpace,
  ...
  const handleOpenDialog = (space?: SupplierSpace) => {
    if (space) {
