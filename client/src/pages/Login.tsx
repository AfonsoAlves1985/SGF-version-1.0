  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-900">
      <div className="bg-gray-800 p-8 rounded-lg shadow-lg w-96">
        <h1 className="text-2xl font-bold text-white mb-6 text-center">Login SGA</h1>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full bg-gray-700 text-white px-4 py-2 pr-11 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
                placeholder="******"
              />
              <button
                type="button"
